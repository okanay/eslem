...
export const WhatWeDo = () => {
  ...
  return (
    <motion.div
      ...
      style={{ y }}
      className={
        'relative z-20 h-[10vh] w-full border border-zinc-50 bg-zinc-200 bg-noise shadow-md shadow-zinc-700/10'
      }
    >
      <div className={'mx-auto h-full max-w-7xl px-4'}>
        <div className="flex h-full w-full flex-col items-center justify-center sm:items-start">
          <div
            className={
              'flex flex-row items-center justify-start gap-4 sm:gap-8'
            }
          >
            ...
            <h1
              className={
                'text-center text-sm font-bold tracking-wider text-zinc-800 basePhone:text-base sm:text-2xl'
              }
            >
