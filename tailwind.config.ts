  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        third: {
          '50': withOpacity('--third-50'),
          '100': withOpacity('--third-100'),
          '200': withOpacity('--third-200'),
          '300': withOpacity('--third-300'),
          '400': withOpacity('--third-400'),
          '500': withOpacity('--third-500'),
          '600': withOpacity('--third-600'),
          '700': withOpacity('--third-700'),
          '800': withOpacity('--third-800'),
          '900': withOpacity('--third-900'),
          '950': withOpacity('--third-950'),
        } as any,
        backgroundImage: {
          // "image": "url('/image.png')",
        },
